...
TEST(SplineTests, MainTest){
    ...
    std::array<double, 10> values10{};
    std::array<double, 20> values20{};
    std::array<double, 40> values40{};
    std::array<double, 80> values80{};
    std::array<double, 160> values160{};

    std::array<double, 5> points5{};
    std::array<double, 10> points10{};
    std::array<double, 20> points20{};
    std::array<double, 40> points40{};
    std::array<double, 80> points80{};
    std::array<double, 160> points160{};
    ...
    CubicSpline<double, double, 4> s5{points5, values5};
    CubicSpline<double, double, 9> s10{points10, values10};
    CubicSpline<double, double, 19> s20{points20, values20};
    CubicSpline<double, double, 39> s40{points40, values40};
    CubicSpline<double, double, 79> s80{points80, values80};
    CubicSpline<double, double, 159> s160{points160, values160};
